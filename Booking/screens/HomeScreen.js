  ...
  return (
    <>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator>
            ...
            >
              ...
              <Text style={{ color: "white", fontSize: 15, fontWeight: "500" }}>
                Bạn có thể giảm giá 15% nếu đi cùng 1 trẻ em
              </Text>
            </Pressable>
            <Pressable
              style={{
            ...
            >
              ...
              Bạn có thể giảm giá 10% nếu đi cùng 2 trẻ em
              </Text>
            </Pressable>
            <Pressable
              style={{
            ...
            >
              ...
              <Text style={{ fontSize: 15, fontWeight: "500" }}>
                Bạn có thể giảm giá 5% nếu đi cùng 3 trẻ em
              </Text>
            </Pressable>
          </ScrollView>
          <Pressable
      ...
      <BottomModal
        ...
        modalTitle={<ModalTitle title="Số lượng phòng và người" />}
        modalAnimation={
          new SlideAnimation({
            slideFrom: "bottom",
          })
      ...
      >
        <ModalContent style={{ width: "100%", height: 310 }}>
          ...
          >
            ...
            >
              <Pressable
                onPress={() => setChildren(Math.max(0, rooms - 1))}
                style={{
                  width: 30,
                  //height: 26,
                  borderRadius: 15,
