...
const PlacesScreen = () => {
  ...
  const filters = [
    {
      id: "0",
      filter: "Chi phí :Từ Thấp đến Cao",
    },
    {
      id: "1",
      filter: "Chi phí :Từ Cao xuống Thấp",
    },
  ];
  ...
  return (
    <View>
      ...
      <ScrollView style={{ backgroundColor: "#F5F5F5", marginBottom: "10%" }}>
        {sortedData
      ...
      <BottomModal
        ...
        modalTitle={<ModalTitle title="Lựa chọn" />}
        modalAnimation={
          new SlideAnimation({
            slideFrom: "bottom",
          })
      ...
      >
        <ModalContent style={{ width: "100%", height: 280 }}>
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <Text style={{ textAlign: "center" }}>Sắp xếp</Text>
            </View>
